...
//open database
const dbPromise = idb.open('curr-cnv-db', 1, upgradeDB => {
  ...
  /***********************communication with the free currency converter api******************************/
  //fetch json from url
  const freeCurrencyConverterUrl = 'https://free.currencyconverterapi.com/api/v5/currencies';
  fetch(freeCurrencyConverterUrl).then(response => {
